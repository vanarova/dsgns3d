...
*************************************************/
// Model parameters
model_filename = "fox.stl";
model_rotate = [0,0,0];
model_translate = [0,0,0];
model_scale = 1;

// Mold parameters
mold_width = 300;			// Measured along X axis
mold_height = 200;			// Measured along Y axis
mold_depth = 100;			// Measured along Z axis
